...
public partial class MchdView : UserControl
{
    ...
    private void Build()
    {
        ...
        FlowButtons(465, addButton, editButton, revokeButton, archiveButton, refreshButton, exportButton);

        _grid.SetBounds(15, 60, 1000, 560);
        _grid.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Bottom;
        UiTheme.ApplyGridStyle(_grid);

        Controls.AddRange(new Control[] { _searchBox, _statusFilter, _registrationFilter, addButton, editButton, revokeButton, archiveButton, refreshButton, exportButton, _grid });
        ...
        addButton.Click += (_, _) => Save(new MchdEditForm(), false);
